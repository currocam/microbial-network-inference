...
infiles <- list.files("steps/network_properties_stability/", ".Rds", full.names = TRUE)
...
ggsave(
  "figures/05-network_properties_stability/distances_spearman.pdf",
  units = "mm",
...
ggsave(
  "figures/05-network_properties_stability/modularity.pdf",
  units = "mm",
  width = fig.witdh, height = fig.height,
)
...
ggsave(
  "figures/05-network_properties_stability/hub_score.pdf",
  units = "mm",
  width = fig.witdh, height = fig.height,
)
...
ggsave(
  "figures/05-network_properties_stability/cluster_ami.pdf",
  units = "mm",
  width = fig.witdh, height = fig.height,
)
