...
\hypersetup{
  pdftitle={Assesing reliability of learning Gaussian graphical models from microbial abundances},
...
numbers of edges (graph size). More details on the simulation of these
